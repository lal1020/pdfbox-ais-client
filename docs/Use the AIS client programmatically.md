...
Then use the classes from the _com.swisscom.ais.client_ package for signing and timestamping PDF documents.

See the sample files in _src/main/java/com/swisscom/ais_ for more information on how to use this code programmatically.
